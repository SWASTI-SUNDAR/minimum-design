const OurEthos = () => {
  return (
    <section id="our-ethos" className="bg-white py-12 md:py-20 px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 lg:pr-10">
            ...
            <div className="space-y-6">
              {/* Intro Paragraph */}
              <p className="text-sm lg:text-sm leading-relaxed text-gray-700 font-light">
              ...
              <div className="space-y-2">
                <h3 className="text-sm lg:text-sm lato-black text-black">
                  1. Relevant Innovation
                </h3>
                <p className="text-sm lg:text-sm leading-relaxed text-gray-700 font-light">
